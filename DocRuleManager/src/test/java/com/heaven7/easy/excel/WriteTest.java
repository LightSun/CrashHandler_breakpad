package com.heaven7.easy.excel;
...
import com.heaven7.easy.excel.bean.*;
import com.heaven7.easy.excel.head.ComplexHeadData;
...
public class WriteTest {
    ...
    public void simpleWrite() {
        ...
        // 写法1 JDK8+
        // since: 3.0.0-beta1
        String fileName = TestFileUtil.getPath() + "simpleWrite1" + ".xlsx";
        ...
        // 写法2
        fileName = TestFileUtil.getPath() + "simpleWrite2" + ".xlsx";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
        // 如果这里想使用03 则 传入excelType参数即可
        EasyExcel.write(fileName, DemoData.class).sheet("模板").doWrite(data());

        // 写法3
        fileName = TestFileUtil.getPath() + "simpleWrite3" + ".xlsx";
