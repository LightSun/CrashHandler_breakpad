...
public class DocxTest {
    ...
    public void test1() throws InvalidFormatException {
        WordprocessingMLPackage wordMLPackage = WordprocessingMLPackage.createPackage(); // 获取页面设置
        SectPr pageMar = wordMLPackage.getDocumentModel ().getSections ().get (0).getSectPr ();
        // 设置边距，单位为磅
//        pageMar.setLeft (720);
//        pageMar.setRight (720);
//        pageMar.setTop (720);
//        pageMar.setBottom (720);
//        pageMar.setHeader (720);
//        pageMar.setFooter (720);
    }
    ...
    public void createDocx() {
        ...
        docxPainter
                ...
                .add(DocxFactory.createParagraph(new DocxText("完成配置文件的验证和主窗口创建等初始化工作",
                        DocxStyleEnum.CONTENT.getDocxStyle())))
                // 添加表格
                .add(DocxFactory.createTable(docxTable, docxPainter.getWpk()))
                // 保存
                .save(new File("test_docx/1.docx"));
    }
    ...
    public void createDocxByTemplate() {
        ...
        docxPainter
                ...
                .add(DocxFactory.createParagraph(new DocxText("这是正文")))
                // 保存
                .save(new File("test_docx/template-result.docx"));
    }
    ...
    public void positionWriteDocx() {
        new DocxPainter(new File("docx/position-write.docx"))
                ...
                .save(new File("test_docx/position-write-result.docx"));
    }
